...
class HistoryHomePage extends Component {
  ...
  onDelete = itemId => {
    ...
    const filterHistoryItemList = historyList.filter(
      eachItem => eachItem.id !== itemId,
    )

    this.setState({historyList: filterHistoryItemList})
  }

  render() {
    const {historyList, searchInput} = this.state
    // const {searchInput} = this.state
    const searchableHistoryLists = historyList.filter(eachItem =>
